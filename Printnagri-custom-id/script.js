const downloadCharacterSheet = () => {
  ...
  // Bind gender
  // bindInputToElement(document.getElementById('gender'), document.getElementById('id-card-gender'));
  ...
  bindInputToElement(document.getElementById('class'), document.getElementById('id-card-class'));

  bindInputToElement(document.getElementById('fname'), document.getElementById('id-card-fname'));

  bindInputToElement(document.getElementById('contact'), document.getElementById('id-card-contact'));

  bindInputToElement(document.getElementById('address'), document.getElementById('id-card-address'));
  ...
  // Bind mugshot-2
  document.getElementById('mugshot-2').addEventListener('change', function () {
    if (this.files && this.files[0]) {
      var FR = new FileReader();
      FR.onload = function (e) {
        var img = document.getElementById('id-card-mugshot-2');
        img.src = e.target.result;
      };
      FR.readAsDataURL(this.files[0]);
    }
